...
/**
 * The customer's own support / requests panel. Tickets are siloed to this tenant —
 * a customer never sees, and cannot reach, another tenant's requests.
 */
  ...
  return (
    <div className="mx-auto max-w-3xl px-8 py-10">
      ...
      <p className="mt-1 text-sm text-gray-600">
        File a request or question for the Prism team. Everything here is private
        to {tenant.name} — your workspace, your tickets.
      </p>
