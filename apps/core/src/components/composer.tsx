 ...
 * pulled in automatically and the price updates live. "Software your way."
 */
export function Composer({ modules }: { modules: ComposableModule[] }) {
  ...
  return (
    <div className="mt-8">
      ...
      <div className="mt-8 flex flex-col gap-4 rounded-xl border border-gray-200 bg-white p-5 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="text-right">
          <p className="text-xs font-semibold uppercase tracking-wide text-gray-500">
            {effective.size} module{effective.size === 1 ? "" : "s"} · estimated
          </p>
